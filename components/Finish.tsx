    ...
    return (
        <div>
            ...
            <div className='grid gap-2 grid-cols-2'>
                ...
                className="w-full flex justify-center py-2 px-4 border border-white rounded-md shadow-sm shadow-white text-sm font-medium text-white hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
                >
                    Get another test
                </button>
                <button 
                ...
                className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm shadow-white text-sm font-medium text-black bg-white hover:bg-gray-300 disabled:bg-slate-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
                >
                    {
