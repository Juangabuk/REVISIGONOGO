...
const FirstGuide:React.FC<Props> = ({setState, state}) => {
    ...
    return (
        ...
        <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-620">
            ...
            className="w-full mt-5 flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm shadow-white text-sm font-medium text-black bg-white hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-300"
            >
            Lanjut 
            </button>
        </div>
